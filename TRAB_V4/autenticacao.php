...
.container {
    max-width: 600px;
    margin: auto;
    background-color: #2e2e2e; /* Cor de fundo da caixa */
    padding: 20px;
    border-radius: 5px;
...
.btn {
    ...
    background-color: #007bff; /* Azul para botões primários */
    border: none;
    border-radius: 3px;
    cursor: pointer;
}
...
.btn-secondary {
    background-color: #6c757d; /* Cinza escuro para botões secundários */
}
...
label {
    ...
    font-weight: bold;
    margin-bottom: 5px;
    color: #e0e0e0; /* Texto do rótulo em branco */
}
...
input[type="text"] {
    ...
    background-color: #333; /* Fundo do campo de entrada */
    color: #e0e0e0; /* Texto claro no campo de entrada */
    border-radius: 3px;
}
...
.modal-content {
    background-color: #2e2e2e; /* Cor de fundo do modal */
    margin: 10% auto;
    padding: 20px;
