...
<head>
    ...
    <style>
        ...
        .error-message {
            color: #ff4c4c; /* Vermelho claro para mensagens de erro */
            margin-bottom: 10px;
        }

        .success-message {
            color: #4caf50; /* Verde claro para mensagens de sucesso */
            margin-bottom: 10px;
        }
        ...
        .retry-buttons input[type="submit"] {
            padding: 10px 20px;
            margin: 10px;
            background-color: #333; /* Cor de fundo dos botões escura */
            color: #e0e0e0; /* Cor do texto dos botões clara */
            border: none;
            border-radius: 3px;
            cursor: pointer;
            font-size: 16px;
        ...
        .retry-buttons input[type="submit"]:hover {
            background-color: #555; /* Cor de fundo dos botões em hover */
        }
    </style>
</head>
<body>
